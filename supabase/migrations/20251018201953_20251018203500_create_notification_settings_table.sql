/*
  # Table notification_settings pour configuration des notifications admin

  1. Nouvelle Table
    - `notification_settings` (paramètres de notifications)
      - `id` (uuid, clé primaire)
      - `owner_id` (lien vers profiles)
      - Tous les paramètres de notifications
      - Préférences d'email, SMS, etc.
...
-- Policies: Chaque utilisateur peut seulement gérer ses propres paramètres
