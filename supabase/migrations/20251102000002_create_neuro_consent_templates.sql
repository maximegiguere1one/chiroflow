...
-- =====================================================
-- TABLE 4: EXAMEN NEUROLOGIQUE DÉTAILLÉ
-- =====================================================
CREATE TABLE IF NOT EXISTS neurological_exams (
  ...
  -- Signes vitaux (référence autre formulaire)
  ...
  -- Démarches et autres tests (référence)
  gait_tests_reference text,
  
  -- Réflexes ostéo-tendineux (référence)
  rot_reference text,
  
  -- Coordination (JSON pour détails)
  coordination_data jsonb DEFAULT '{
    "finger_index": {"left": "N", "right": "N"},
    "heel_knee": {"left": "N", "right": "N"},
    "finger_finger": {"left": "N", "right": "N"},
    "pronation_supination": {"left": "N", "right": "N"},
    "marionnette": {"left": "N", "right": "N"},
    "index_thumb": {"left": "N", "right": "N"},
    "foot_pedaling": {"left": "N", "right": "N"}
  }'::jsonb,
  
  -- Évaluation motrice détaillée (JSON)
  motor_evaluation jsonb DEFAULT '{}'::jsonb,
  
  -- Sensibilité détaillée (JSON)
  sensibility_data jsonb DEFAULT '{
    "elementary": {},
    "discriminative": {}
  }'::jsonb,
  
  -- Nerfs crâniens détaillés (JSON)
  ...
  CONSTRAINT neuro_exams_contact_owner_fk 
...
-- =====================================================
-- TABLE 5: CONSENTEMENTS TÉLÉCONSULTATION
-- =====================================================
CREATE TABLE IF NOT EXISTS teleconsultation_consents (
  ...
  CONSTRAINT telecons_consents_contact_owner_fk 
    FOREIGN KEY (contact_id, owner_id) 
    REFERENCES contacts(id, owner_id)
);
...
-- =====================================================
-- TABLE 6: TEMPLATES DE FORMULAIRES INTELLIGENTS
-- =====================================================
CREATE TABLE IF NOT EXISTS form_templates (
  ...
  -- Données template (JSON flexible)
